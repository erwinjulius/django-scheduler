...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Occurrence.done'
        db.add_column(u'schedule_occurrence', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Event.done'
        db.delete_column(u'schedule_event', 'done')


    def backwards(self, orm):
        # Deleting field 'Occurrence.done'
        db.delete_column(u'schedule_occurrence', 'done')

        # Adding field 'Event.done'
        db.add_column(u'schedule_event', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'actstream.action': {
            ...
            'domain_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
